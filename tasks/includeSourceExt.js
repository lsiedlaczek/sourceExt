...
module.exports = function(grunt) {
  ...
  // Register the task.
  grunt.registerMultiTask('includeSourceExt', 'Include lists of files into your source files automatically.', function() {
    grunt.log.debug('Starting task "includeSourceExt"...');
